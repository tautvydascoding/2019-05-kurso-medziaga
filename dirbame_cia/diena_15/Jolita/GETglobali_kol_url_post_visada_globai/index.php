...
<html>
    ...
    <body>
        ...
        <h1>PHP forma - duomenu perkelimas is vieno failo i kita naudojant GET</h1>
        <p>(ivesta informacija taps kinatmaisiais php i masyva GET)</p>
...
<form class="" action="registracija.php" method="get">
    ...
    <input required type="text" name="tlf" value="" placeholder="Jusu telefonas">
