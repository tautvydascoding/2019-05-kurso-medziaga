...
<html lang="en" dir="ltr">
    ...
    <body>
        <div class="container-fluid">
            <h2>Prekės mergaitėms įdėjimas</h2>
            <form class="" action="prekiu_mergaitems_idejimas.php" method="post" enctype="multipart/form-data">
                ...
                <textarea name="t_aprasymas" rows="4" cols="40"  maxlength="30" required></textarea><br>
