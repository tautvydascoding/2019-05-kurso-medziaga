            ...
            <div class = 'row'>
                <div class = 'col'>
                    ...
                    <table style = 'width: 100%'>
                        <tr>
                            <tr>
                                <th class="border0"><a href = '../prekiu_mergaitems_idejimas.php'><button class="btn btn-success">Įdėti prekę</button></th></a>
                            </tr>
                        ...
                        <?php
                        echo "<h2 class= 'bg-red'>Prekių mergaitėms valdymas</h2> <h3>Norėdami matyti pasikeitimus po ištrinimo ar redagavimo spauskite perkrauti (F5).</h3>";
                        ...
                        if (mysqli_num_rows($prekeOBJ) > 0) {
                            while ($vienaPrekeArray == true) {
                                echo "
                                                ...
                                                <td class = 'text-center'> <a href ='trinti-preke-mergaitems.php/?id=" . $vienaPrekeArray['id'] ."'><button class = 'btn btn-danger'>Trinti</button></a> </td>
                                                <td class = 'text-center'> <a href ='prekiu-mergaitems-redagavimo-forma.php/?id=" . $vienaPrekeArray['id'] ."'><button class = 'btn btn-danger'>Redaguoti</button></a> </td>
                                            </tr>
