...
$manoSQLimg = "UPDATE berniuku_prekes SET img_name = '$img_name' WHERE id = $nr";
$rezultataiIMG = mysqli_query($prisijungimas,  $manoSQLimg);
    ...
    $kaina = $_POST['kaina'];
    $manoSQL = "UPDATE berniuku_prekes SET pavadinimas = '$pavadinimas', trumpas_aprasymas = '$t_aprasymas', aprasymas = '$aprasymas', kaina = '$kaina' WHERE id = $nr";
