                        ...
                        <div class="row">
                          ...
                          <form class="form-group row justify-content-center bg-light" id='login' action='login.php' method='post'>
                            ...
                            <div class="col-sm-10 m-3">
                              <input class="form-control" type="text" id='username'  maxlength="50" placeholder="Username" required/>
                            </div>

                            <div class="col-sm-10 m-3">
                              <input class="form-control" type="password" name="password" placeholder="Item price" required/>
                            </div>
