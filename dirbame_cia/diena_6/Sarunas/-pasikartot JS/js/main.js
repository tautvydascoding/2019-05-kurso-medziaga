...
function getPazymiuVidurkis2(x1, zzz, x3, x4, x5) {
    let ats = (x1 + zzz + x3 + x4 + x5) / 5;
    console.log( vardas + " " + "Vidurkis " + ats);
}
pazyniuVidurkis( 10, 10, 10, 10, 10);
pazyniuVidurkis( 2, 2, 2, 5, 6);
pazyniuVidurkis( 4, 5, 4, 6, 7);
 ...
 function suma( x1, x2){
   let ats = x1 + x2;
   return ats; //grazinni i iskvietimo vieta salia parasyta reiksme
