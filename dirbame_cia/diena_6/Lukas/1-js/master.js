...
//document.write("<span class='bg-info'>labas</span>");
//window.alert("Viso"); //ilgesnis budas
//alert("viso"); //trumpesnis budas
//let ivestasTekstas = prompt("Iveskite savo varda");
//console.log(ivestasTekstas);
let zodis = prompt("ivesk antraste");
document.querySelectorAll('h1')[1].innerHTML = "zodis";

// let dalyviai = parseInt(prompt("Kiek zmoniu dalyvaus?")); // parseint pavercia string i int
// let gerimai = parseInt(prompt("Ivesk kiek gerimu tenka vienam zmogui?"));
// console.log(typeof(dalyviai)); // pasiziureti koks tipas
// function skaiciavimas() {
//     atsakymas = dalyviai + gerimai;
//     document.write("Jums reikes: " + atsakymas + " gerimu.");
// }
//
// skaiciavimas();
//----Elemento duomenys--------
// auksto paemimas:
var aukstis = document.querySelector('h1').clientHeight = "500px";   // clientHeight includes the height and vertical padding.
