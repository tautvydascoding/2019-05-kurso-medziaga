...
//  iskviesti f-ja 3 kartus, kad atspausdintu 3 skirtingas antrastes:  "BMW pinga, nes daugeja", "Greik pageres orai", "Vasaros vis salteja"
 function printAntraste(x) {
     document.querySelector("body").innerHTML += "<p>" + "BMW pinga, nes daugeja" + "</p>";
     document.querySelector("body").innerHTML += "<p>" + "Greik pageres orai" + "</p>";
     document.querySelector("body").innerHTML += "<p>" + "Vasaros vis salteja" + "</p>";
 }
...
function printStraipsnis(x) {
    ...
    document.querySelector("body").innerHTML += "<p>" + "paduota teksta tarp" + "</p>";
