...
//tikriname ar sk lyginis - yra liekana ar ne?
// % - padalina ir grazina liekana

let sk = 5;
if (sk % 3 == 0){ // % reiskia lyginis/nelyginis
...
// funkcijoje sukurti kintamaji: let vardas = "Tomas"
...
//==========================
 ...
 function myName ( vardas ) { //  vardas - local kintamasis
     ...
     console.log("this.vardas - f-jos viduje: ",  this.vardas);    //Jonas  this - pasiekia ~global kintamuosius (tavo tecio kintamuosius)
 }
 myName("PETRAS");
//======================TEKSTO ISVEDIMAS===============
