...
// tikriname ar sk lyginis
//  % - padalina ir grazina liekana (parodo liekana)
let sk = 8;
if(sk % 2 == 0 ) {
...
//==========================
 ...
 function myName ( vardas ) { //  vardas - local kintamasis
     ...
     console.log("this.vardas - f-jos viduje: ",  window.vardas); //Jonas    // this - pasiekia ~global kintamuosius (tavo tecio kintamuosius)
 }
 myName("PETRAS");
//======================TEKSTO ISVEDIMAS===============
