...
$gydytojaiOBJ = getDoctors(40); //paimk pvz 20pirmuju gydytoju
//print_r($gydytojaiOBJ);

//ar yra isvis gydytoju duomenu bazeje
...
$vienasgydarray = mysqli_fetch_assoc($gydytojaiOBJ); //imtu jau kita eilute, spausdins kita gydytoja
    }
}

//mysqli_fetch_assoc paima viena eilute is objekto, pavercia ja i masyava, nutruksta darbas.
//atsimena, kad pirma jau pirma nuskaite, ciklo metu skaitys vis +1
